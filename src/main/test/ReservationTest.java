...
//        boolean result = reservationService.makeReservation(reservationDTO, null);
//        assertTrue(result);
    }
    ...
    @Test
    public void test_makeResWithAddedAmenities() throws SQLException {
        ReservationService reservationService = new ReservationServiceImpl();
        ReservationIdGenerator reservationIdGenerator = new ReservationIdGenerator();
        LocalDateTime currentDateTime = LocalDateTime.now();
        LocalDate checkinDate = LocalDate.of(2026, Month.MAY, 8);
        LocalDate checkoutDate = LocalDate.of(2026, Month.MAY, 12);
        ReservationDTO reservationDTO = new ReservationDTO(30, 6,3, reservationIdGenerator.generateId(), 700, currentDateTime, checkinDate, checkoutDate, 2, 1, Confirmed);
        List<String> selectedAmenities = new ArrayList<>();
        selectedAmenities.add("1");
        selectedAmenities.add("10");
        boolean successfulRes = reservationService.makeReservation(reservationDTO, selectedAmenities);
        assertTrue(successfulRes);
    }
